    ...
    <div className="content-area">
      <div className="content-inner">
        ...
        <div className="section">
          ...
          <p>over 18 years of experience in IT industry with 10+ years in europe. specialized in sales, account management, and CXO relationships. deep expertise in digital transformation for travel and transportation companies. highly motivated with a desire for personal impact, adaptable, quick learner and passionate about solving business problems.</p>
        </div>
        ...
        <div className="section">
          ...
          <p>passionate about world economics and running - training for my second <a href="https://www.lidingoloppet.se/en/" target="_blank" rel="noopener noreferrer">lidingolöppet</a> 15K.</p>
          
          <p>currently enrolled in multiple courses, not sure if i will finish them, but still i will end up challenging myself - <a href="https://cs50.harvard.edu/" target="_blank" rel="noopener noreferrer">harvard's CS50</a>, <a href="https://www.maven.com/" target="_blank" rel="noopener noreferrer">maven AI for product managers</a>, <a href="https://www.boot.dev/" target="_blank" rel="noopener noreferrer">boot.dev</a> python.</p>
        </div>
      </div>
    </div>
  );
